...
public interface CustomerDBQ {
    ...
    public abstract String register(String Username, String Password, String FirstName, String LastName, String Email, String address, String SSN,
    ...
    public abstract String logIn(String Username, String Password) throws SQLException; // should get username and password using SELECT Query
    ...
    public abstract String retrievePassword(String Username, String SecurityQuestion, String SecurityAnswer) throws SQLException; // should get password using SELECT query
    ...
    public abstract String deleteFlight(String FlightID) throws SQLException; // should delete flight using DELETE query
    public abstract String getUserFlights(String Username) throws SQLException;//
